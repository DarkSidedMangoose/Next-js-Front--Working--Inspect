    ...
    <div className="w-[calc(100%-0.75rem)] h-5/6  flex flex-col r ml-3 relative">
      ...
      <div className="flex justify-between w-full mt-4">
        <div className="relative">
          <div className="absolute -bottom-7 left-0 w-16 bg-white text-center text-mainTextCol p-1 rounded-md shadow-lg text-lg">
            ₾{priceRange[0]}
          </div>
        </div>
        <div className="relative">
          <div className="absolute -bottom-7 right-0 w-16 bg-white text-center text-mainTextCol p-1 rounded-md shadow-lg text-lg">
            ₾{priceRange[1]}
          </div>
        </div>
      </div>
